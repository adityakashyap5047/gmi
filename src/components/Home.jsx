...
const Home = () => {
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] overflow-hidden text-white px-6 py-16 md:py-24 flex flex-col items-center">
      {/* Glowing background */}
      ...
      >
        <h2 className="text-lg text-purple-400 font-semibold uppercase tracking-widest mb-2">
          Welcome to Trackr
        </h2>
